...
Usage:
  python ci_run_single.py --config monke/configs/gmail.yaml --log-file logs/gmail.rich.log
...
ENV_PATH = (Path(__file__).parent / "env.test").resolve()
...
async def _amain() -> int:
    ...
    # Remove the second occurrence of "monke"
    parts.pop(parts.index("monke", parts.index("monke") + 1))
