...
#     """Service class for handling credentials."""

#     @staticmethod
#     async def get_secret(user: schemas.User, integration_short_name: str) -> str:




#     @staticmethod
#     async def get_integration_credential(user: schemas.User, integration_short_name: str) -> str:
