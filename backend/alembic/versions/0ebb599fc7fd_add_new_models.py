...
def upgrade():
    ...
    op.add_column(
        "sync", sa.Column("white_label_user_identifier", sa.String(length=256), nullable=True)
    )
    op.create_unique_constraint(
        "uq_white_label_user", "sync", ["white_label_id", "white_label_user_identifier"]
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column(
        "sync", sa.Column("schedule", sa.VARCHAR(length=100), autoincrement=False, nullable=False)
    )
