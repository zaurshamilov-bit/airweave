...
def upgrade():
    ...
    op.create_table('sync_dag_definition',
    ...
    sa.ForeignKeyConstraint(['created_by_email'], ['user.email'], ),
    sa.ForeignKeyConstraint(['dag_id'], ['sync_dag_definition.id'], ),
    ...
    sa.ForeignKeyConstraint(['created_by_email'], ['user.email'], ),
    sa.ForeignKeyConstraint(['dag_id'], ['sync_dag_definition.id'], ),
    sa.ForeignKeyConstraint(['from_node_id'], ['dag_node.id'], ),
    sa.ForeignKeyConstraint(['modified_by_email'], ['user.email'], ),
    sa.ForeignKeyConstraint(['organization_id'], ['organization.id'], ),
    sa.ForeignKeyConstraint(['to_node_id'], ['dag_node.id'], ),
    sa.PrimaryKeyConstraint('id'),
...
def downgrade():
    ...
    op.drop_table('sync_dag_definition')
    # ### end Alembic commands ###
