    ...
    try:
        ...
        raise HTTPException(
            ...
            detail=(
                ...
                "backend/airweave/platform/auth/yaml/dev.integrations.yaml file, then restart the "
...
async def test_sync(
    *,
    ...
    _ = await sync_service.run(sync_schema, sync_job_schema, sync_dag_schema, user_schema)
