...
export function CursorIcon(props: SVGProps<SVGSVGElement>) {
    return (
        ...
        >
            ...
            <path d="M22.35 6L11.925 24V12L22.35 6z" fill="#aaa"></path>
            ...
            <defs>
                <linearGradient gradientUnits="userSpaceOnUse" id="lobe-icons-cursorundefined-fill-0" x1="11.925" x2="11.925" y1="12" y2="24">
                    <stop offset=".16" stopColor="#fff" stopOpacity=".5"></stop>
                ...
                <linearGradient gradientUnits="userSpaceOnUse" id="lobe-icons-cursorundefined-fill-1" x1="22.35" x2="11.925" y1="6.037" y2="12.15">
                    <stop offset=".182" stopColor="#ccc" stopOpacity=".5"></stop>
                    <stop offset=".715" stopColor="#fff" stopOpacity=".2"></stop>
                </linearGradient>
                <linearGradient gradientUnits="userSpaceOnUse" id="lobe-icons-cursorundefined-fill-2" x1="11.925" x2="1.5" y1="0" y2="18">
                    <stop stopColor="#ddd" stopOpacity=".8"></stop>
                    <stop offset=".667" stopColor="#fff" stopOpacity=".4"></stop>
                </linearGradient>
            </defs>
        </svg>
    );
