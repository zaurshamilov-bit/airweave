...
export function DocsCard() {
  ...
  return (
    <div className="relative overflow-hidden rounded-lg border bg-gradient-to-br from-primary-100 to-secondary-100 p-8">
      ...
      />
      <div 
        className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/4 w-64 h-64 opacity-20"
        style={{
      ...
      <div className="relative z-10 space-y-4">
        ...
        <Button
          ...
          className="bg-white text-primary-400 hover:bg-primary-100 hover:text-primary-500 transition-all duration-300 shadow-sm hover:shadow-md"
        >
      ...
      {/* Decorative elements */}
      <div
        className="absolute right-0 top-0 h-full w-1/3 animate-float"
        style={{
          background: "linear-gradient(109.6deg, rgba(223,234,247,0.3) 11.2%, rgba(244,248,252,0.3) 91.1%)",
          borderRadius: "50%",
