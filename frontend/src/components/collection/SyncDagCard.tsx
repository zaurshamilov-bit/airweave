...
export const SyncDagCard = ({
    ...
    return (
        <>
            <style>
                {`
                    .sync-dag-flow .react-flow__handle,
                    .sync-dag-flow .react-flow__handle-connecting,
                    .sync-dag-flow .react-flow__node,
                    .sync-dag-flow .react-flow__edge,
                    .sync-dag-flow .react-flow__pane,
                    .sync-dag-flow .react-flow__viewport,
                    .sync-dag-flow * {
            ...
            <Card className={cn(
                ...
                <CardContent className="p-0 pb-0">
                    <div
                        ...
                        className="h-[320px] w-full overflow-hidden sync-dag-flow"
