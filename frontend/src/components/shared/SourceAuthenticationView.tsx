          ...
          <div className="flex items-center justify-center gap-8 pt-12 pb-4">
            ...
            <div className="flex items-center justify-center">
              <p className={cn(
                ...
                "bg-gradient-to-r from-gray-600 via-white to-gray-600 bg-clip-text text-transparent",
                "animate-[textShimmer_2.5s_ease-in-out_infinite]",
                isDark ? "from-gray-400 via-white to-gray-400" : "from-gray-600 via-gray-900 to-gray-600"
              )}
                style={{
