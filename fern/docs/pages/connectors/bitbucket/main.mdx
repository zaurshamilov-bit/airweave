...
Bitbucket source connector integrates with the Bitbucket REST API to extract and synchronize data from your
Bitbucket workspaces and repositories. It supports syncing workspaces, repositories, directories,
