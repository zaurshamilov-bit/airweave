...
HubSpot source connector integrates with the HubSpot CRM API to extract and synchronize customer relationship
management data. It provides comprehensive access to contacts, companies, deals, and support tickets.
