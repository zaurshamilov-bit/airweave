...
Authentication configuration class: `StripeAuthConfig`
...
|-------|------|-------------|----------|
| api_key | str | The API key for the Stripe account. Should start with 'sk_test_' for test mode or 'sk_live_' for live mode. | Yes |
