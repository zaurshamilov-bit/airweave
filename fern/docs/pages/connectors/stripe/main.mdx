...
Stripe source connector integrates with the Stripe API to extract and synchronize comprehensive payment
and financial data from your Stripe account. It provides access to all major Stripe resources
