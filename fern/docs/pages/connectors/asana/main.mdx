...
<div className="connector-header" style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
  <img src="icon.svg" alt="Asana logo" width="48" height="48" className="connector-icon" />
  <h1 style={{ margin: 0 }}>Asana</h1>
</div>
...
<Accordion title="AsanaFileEntity">
...
| Field | Type | Description |
|-------|------|-------------|
| task_gid | str | GID of the task this file is attached to |
...
| updated_at | Optional[datetime] | The time at which this file was last modified |
| created_at | Optional[datetime] | The time at which this file was created |
