...
Outlook Mail source connector integrates with the Microsoft Graph API to extract and synchronize email data
from Outlook mailboxes. It provides comprehensive access to mail folders, messages, and
