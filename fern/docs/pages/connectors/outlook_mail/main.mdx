...
<Accordion title="OutlookMessageDeletionEntity">
...
| deletion_status | str | Status indicating the entity was removed (e.g., 'removed') |

</Accordion>
<Accordion title="OutlookMailFolderDeletionEntity">
...
| Field | Type | Description |
|-------|------|-------------|
| folder_id | str | ID of the deleted folder |
| deletion_status | str | Status indicating the entity was removed (e.g., 'removed') |
