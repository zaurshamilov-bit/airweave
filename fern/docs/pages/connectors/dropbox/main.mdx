...
Dropbox source connector integrates with the Dropbox API to extract and synchronize files and folder structures
from your Dropbox account. It supports downloading and processing files.
