...
OneDrive source connector integrates with the Microsoft Graph API to extract and synchronize files from
OneDrive personal and business accounts. It supports various OneDrive scenarios including
