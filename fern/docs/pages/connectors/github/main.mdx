...
| url | str | URL to view the file |
| language | Optional[str] | Programming language of the file |
| line_count | Optional[int] | Number of lines in the file |
| is_binary | bool | Flag indicating if file is binary |
| path_in_repo | str | Path of the file within the repository |
| last_modified | Optional[datetime] | Last modification timestamp |
| commit_id | Optional[str] | Last commit ID that modified this file |
| repo_name | str | Name of the repository containing this file |
| repo_owner | str | Owner of the repository |
| content | Optional[str] | File content if available |
| breadcrumbs | List[Breadcrumb] | Breadcrumb navigation path |
