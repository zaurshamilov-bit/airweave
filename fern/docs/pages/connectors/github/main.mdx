...
| item_type | Optional[str] | Type of content. Typically  |
...
| content | Optional[str] | File content (base64-encoded) if retrieved via  |
| encoding | Optional[str] | Indicates the encoding of the content (e.g.,  |
