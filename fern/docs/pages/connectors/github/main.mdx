...
This connector uses a custom configuration class: `GitHubConfig`.

<Card
  title="Configuration Options"
  className="config-card"
  style={{ backgroundColor: 'rgba(0, 100, 0, 0.1)', padding: '16px', marginBottom: '24px' }}
>
...
Schema for GitHub repository entity (ParentEntity).
...
Schema for GitHub code file entity (CodeFileEntity).
