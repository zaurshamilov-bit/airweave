...
<Accordion title="GitHubFileDeletionEntity">
...
| Field | Type | Description |
|-------|------|-------------|
| file_path | str | Path of the deleted file within the repository |
| repo_name | str | Name of the repository containing the deleted file |
| repo_owner | str | Owner of the repository |
| deletion_status | str | Status indicating the file was removed |
