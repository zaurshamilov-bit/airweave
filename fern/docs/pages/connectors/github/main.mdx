...
GitHub source connector integrates with the GitHub REST API to extract and synchronize data from your GitHub
repositories. It supports syncing repository metadata, directory structures, and code files with
