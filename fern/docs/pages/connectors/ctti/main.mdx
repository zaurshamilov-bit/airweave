...
CTTI source connector integrates with the AACT (Aggregate Analysis of ClinicalTrials.gov) PostgreSQL database
to extract and synchronize clinical trial information. It creates web entities that link to
