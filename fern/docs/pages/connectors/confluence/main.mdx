...
<details>
<summary><strong>ConfluenceSpaceEntity</strong></summary>
...
| space_type | Optional[str] | Type of space (e.g.  |
...
| status | Optional[str] | Status of the page (e.g.,  |
...
<details>
<summary><strong>ConfluenceBlogPostEntity</strong></summary>
...
| status | Optional[str] | Status of the blog post (e.g.,  |
...
<details>
<summary><strong>ConfluenceCommentEntity</strong></summary>
...
| status | Optional[str] | Status of the comment (e.g.,  |

</details>

<details>
<summary><strong>ConfluenceDatabaseEntity</strong></summary>
...
<details>
<summary><strong>ConfluenceFolderEntity</strong></summary>
...
| status | Optional[str] | Status of the folder (e.g.,  |

</details>

<details>
<summary><strong>ConfluenceLabelEntity</strong></summary>
...
| label_type | Optional[str] | Type of the label (e.g.,  |
| owner_id | Optional[str] | ID of the user or content that owns label. |

</details>

<details>
<summary><strong>ConfluenceTaskEntity</strong></summary>
...
<details>
<summary><strong>ConfluenceWhiteboardEntity</strong></summary>
...
| status | Optional[str] | Status of the whiteboard (e.g.,  |

</details>

<details>
<summary><strong>ConfluenceCustomContentEntity</strong></summary>
...
| status | Optional[str] | Status of the custom content item (e.g.,  |
