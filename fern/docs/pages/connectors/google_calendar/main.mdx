...
| status | Optional[str] | Status of the event (e.g.,  |
...
| organizer | Optional[Dict[str, Any]] | The organizer of the event. Usually contains  |
| creator | Optional[Dict[str, Any]] | The creator of the event. Usually contains  |
| attendees | Optional[List[Dict[str, Any]]] | Visibility of the event (e.g.,  |
| conference_data | Optional[Dict[str, Any]] | Conference data associated with the event, e.g., hangout or meet link. |
| event_type | Optional[str] | Event type. E.g.,  |
