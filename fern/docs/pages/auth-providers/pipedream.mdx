...
<Callout type="warning">
**Breaking Change (v2.0.0)**: The `external_user_id` field is now required in the auth provider configuration. This field helps map Pipedream accounts to users in your system. Existing integrations will need to be updated to include this field.
</Callout>
